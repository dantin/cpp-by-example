...
int main() {
    ...
    char largeStr[sz];      // NOLINT will hold the result
    // disastrous if we miscalculated the size of largeStr
	strcpy(largeStr, ca1);  // NOLINT copies ca1 into largeStr
    strcat(largeStr, " ");  // NOLINT adds a space at the end of largeStr
    strcat(largeStr, ca2);  // NOLINT concatenates ca2 onto largeStr
